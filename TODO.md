...
- [ ] 깊이 확인 대전(진행 중: run 36223518128 깊이 3 대 1, 36223543825 깊이 2 대 1, 결과 해석 기준은 `PLAN.md` "탐색 효과 확인과 다음 방향"): 시간 무제한에 가깝게 주고 깊이만 고정(예: `limits_a {"depth":1,"movetimeMs":60000}` 대 `{"depth":3,"movetimeMs":60000}`), 약 40판. 깊이 3이 확실히 이기면 탐색 정상(병목은 눈/정답), 아니면 탐색이나 게임 특성 문제. 배경: 기본 설정(0.3초)은 중반 국면에서 완료 깊이 0, 노드 7~12개.
